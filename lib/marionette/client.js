(function(module, ns) {
  ...
  Client.prototype = {
    ...
    scope: function(options) {
      ...
      // The following line is causing a regression where firefox hangs
      // with tab chrome missing and F11/F12 unresponsive.
      // This happens after navigating with the marionette logger plugin
      ...
      var timeout = options.timeout,
          ...
          cmd = {
            ...
            parameters: {
              ...
              newSandbox: options.parameters.newSandbox || false
            }
          };
